"""Read role purpose assignments for one usable Console connection."""
    ...
    async def execute(
        ...
        *,
        ...
        if not decision.allowed:
            raise AccessDeniedError("The actor is not allowed to view role purposes.")
        ...
        return await self.purposes.get_role_purposes_for_connection(
