"""Read welcome settings from exactly one Console-owned platform connection."""
...
class GetPlatformWelcomeSettings:
    authorizer: OrganizationAuthorizer
    connections: PlatformConnectionReader
    welcome_settings: PlatformWelcomeSettingsReader
    ...
    async def execute(
        ...
        *,
        ...
        if not decision.allowed:
            raise AccessDeniedError("The actor is not allowed to view welcome settings.")
        ...
        return await self.welcome_settings.get_welcome_settings_for_connection(
