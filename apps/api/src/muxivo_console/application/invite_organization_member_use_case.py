"""Use case for creating and delivering organization membership invitations."""
...
from muxivo_console.domain.organizations import MembershipResourceScope

logger = logging.getLogger("muxivo_console.application.invite_organization_member")
