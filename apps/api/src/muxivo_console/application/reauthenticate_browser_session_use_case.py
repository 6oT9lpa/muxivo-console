"""Use case for refreshing recent-authentication assurance."""
...
logger = logging.getLogger("muxivo_console.application.reauthenticate_browser_session")


@dataclass(slots=True)
class ReauthenticateBrowserSession:
    """Verify the current password and elevate only the current browser session."""
