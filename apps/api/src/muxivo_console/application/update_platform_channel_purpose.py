"""Update one channel-purpose assignment for a Console-owned connection."""
...
class UpdatePlatformChannelPurpose:
    authorizer: OrganizationAuthorizer
    connections: PlatformConnectionReader
    purposes: PlatformChannelPurposesWriter
    ...
    async def execute(
        ...
        *,
        ...
        if not decision.allowed:
            raise AccessDeniedError("The actor is not allowed to update channel purposes.")
