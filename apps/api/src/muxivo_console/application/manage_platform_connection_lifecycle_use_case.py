"""Use case for safe, idempotent platform connection lifecycle changes."""
...
logger = logging.getLogger("muxivo_console.application.manage_platform_connection_lifecycle")


@dataclass(slots=True)
class ManagePlatformConnectionLifecycle:
    """Apply validated lifecycle transitions and persist retry results atomically."""
