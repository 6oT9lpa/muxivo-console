  ...
  <main :class="['shell', { 'public-shell': !authenticated }]">
    <template v-if="!authenticated">
      ...
      <section id="top" class="hero" aria-live="polite">
        <template v-if="landingTab === 'overview'"><span class="eyebrow">MUXIVO DS ACTIVITY</span><div class="hero-copy"><h1>BE A PART OF<br />SOMETHING<br />MARVELLOUS</h1><p>Muxivo Discord is a modular Discord bot with a protected Activity panel, Creator Alerts, Dev Blog publishing, dynamic voice rooms, analytics and a local Muxivo Core connected to the current production stack.</p></div><div class="feature-grid"><article><span>01</span><h2>Moderation with AI signals</h2><p>Signals, review flows and clear choices for your moderation team.</p></article><article><span>02</span><h2>Creator & developer tools</h2><p>Creator alerts, Dev Blog publishing and dependable operations.</p></article><article><span>03</span><h2>Activity control surface</h2><p>Dashboard, settings, integrations, health and access controls.</p></article><article><span>04</span><h2>Dynamic voice rooms</h2><p>Flexible rooms that your members can manage as they gather.</p></article><article><span>05</span><h2>Server statistics</h2><p>Readable signals for activity, growth, moderation and creators.</p></article><article><span>06</span><h2>Audit & event logs</h2><p>Operational history with safe, searchable system context.</p></article></div><section class="landing-band ai-band"><div><span class="eyebrow">MUXIVO CORE</span><h2>AI moderation that stays understandable.</h2><p>Use behavioural signals, policy controls and structured audit facts to guide safer communities without hiding important decisions.</p></div><div class="capability-grid"><article><strong>Signal-driven</strong><span>Clear moderation context</span></article><article><strong>Policy-aware</strong><span>Rules stay under your control</span></article><article><strong>Browser-ready</strong><span>Safe operator overview</span></article><article><strong>Auditable</strong><span>Every change leaves a trail</span></article></div></section><section class="landing-band demo-band"><div class="demo-copy"><span class="eyebrow">MODERATION PREVIEW</span><h2>See the signal before the action.</h2><p>Review intent, confidence and a suggested response before committing to moderation.</p></div><article class="moderation-demo"><header><span>AI moderation event</span><strong>Review recommended</strong></header><p>Potential invite spam detected in a community channel.</p><dl><div><dt>Confidence</dt><dd>92%</dd></div><div><dt>Suggested action</dt><dd>Review</dd></div><div><dt>Audit status</dt><dd>Recorded</dd></div></dl></article></section><section class="landing-band stack-band"><div><span class="eyebrow">THE STACK</span><h2>One modular foundation.</h2><p>Discord remains the platform authority. Console gives operators a clean browser control surface without moving credentials into the client.</p></div><div class="stack-list"><span>Permissions & access</span><span>Creator publishing</span><span>AI moderation</span><span>Platform control APIs</span></div></section><footer class="public-footer"><div><strong>MUXIVO</strong><span>Discord bot ecosystem</span></div><p>Built for communities, creators and developers.</p><span>© 2026 Muxivo</span></footer></template>
        <template v-else-if="landingTab === 'about'">
          <span class="eyebrow">GET TO KNOW US</span>
          <div class="hero-copy about-copy"><h1>ONE HOME<br />FOR EVERY<br />COMMUNITY BOT</h1><p>Start with Discord today. Muxivo Console is designed as an extensible foundation for the platforms your community will use next.</p></div>
          <section class="about-grid">
            <article><span class="section-label">WHAT WE BUILD</span><h2>Community operations, made coherent.</h2><p>Muxivo brings moderation, creator tools, automation, analytics and access controls into one dependable operating surface.</p></article>
            <article><span class="section-label">HOW IT FEELS</span><h2>Clear for people. Structured for systems.</h2><p>Every screen is designed to explain what is happening, why it matters, and what the next safe action is.</p></article>
          </section>
          <section class="principle-grid">
            <article><span>01</span><h3>Human-first controls</h3><p>Decisions stay understandable and reversible.</p></article>
            <article><span>02</span><h3>Signals, not noise</h3><p>Turn community activity into useful context.</p></article>
            <article><span>03</span><h3>One operating model</h3><p>Use the same vocabulary across every platform.</p></article>
            <article><span>04</span><h3>Ready to extend</h3><p>Add future bots without rebuilding the core.</p></article>
          </section>
          <section class="about-transition"><span class="eyebrow">THE MUXIVO WAY</span><h2>Built for the people behind the community.</h2><p>We believe healthy communities need more than commands. They need calm workflows, visible ownership and tools that grow with their team.</p></section>
          <section class="about-grid about-detail-grid">
            <article><span class="section-label">OUR PILLARS</span><ul class="pillar-list"><li><strong>Clarity</strong><span>Interfaces that reveal intent.</span></li><li><strong>Trust</strong><span>Predictable permissions and audit trails.</span></li><li><strong>Momentum</strong><span>Automation that keeps teams moving.</span></li></ul></article>
            <article><span class="section-label">BY THE NUMBERS</span><div class="facts-grid"><div><strong>01</strong><span>Discord bot live now</span></div><div><strong>03</strong><span>Platform surfaces in the plan</span></div><div><strong>∞</strong><span>Room to grow with your community</span></div></div></article>
          </section>
          <section class="module-preview-grid">
            <article><span>DISCORD</span><h3>Community control</h3><p>Moderation, dynamic voice, creator alerts and an Activity surface for the server you already run.</p></article>
            <article><span>TWITCH</span><h3>Creator operations</h3><p>Planned integration for streams, alerts and a clearer view of your live community.</p></article>
            <article><span>TELEGRAM</span><h3>Conversation workflows</h3><p>Planned integration for a consistent moderation and messaging layer across chats.</p></article>
          </section>
          <section class="access-preview"><div><span class="eyebrow">ACCESS THAT MAKES SENSE</span><h2>The right context for every role.</h2></div><div class="access-roles"><span>Owner <b>Full control</b></span><span>Moderator <b>Safety &amp; operations</b></span><span>Creator <b>Publishing tools</b></span></div></section>
          <section class="about-closing"><span class="eyebrow">ONE CONSOLE, MANY COMMUNITIES</span><h2>Start with what your community needs today.</h2><p>Discord is ready. The platform foundation is being prepared for everything that comes next.</p></section>
          <div class="module-marquee" aria-label="Muxivo modules"><span>MODERATION</span><span>CREATORS</span><span>ACTIVITY</span><span>VOICE</span><span>ANALYTICS</span></div>
          <footer class="public-footer"><div><strong>MUXIVO</strong><span>Community infrastructure, made human.</span></div><p>Discord is the first module. Twitch and Telegram will join the same operational foundation.</p><span>© 2026 Muxivo</span></footer>
        </template>
