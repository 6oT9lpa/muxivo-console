...
`0270a7d`. The canonical `console.muxivo.pro` host remains separate and still
...
rollback. The frontend release `0270a7d` is installed at
`/srv/muxivo-console/web`, and its previous web root is retained at
`/srv/muxivo-console/web.backup-0270a7d` for rollback. The disabled
