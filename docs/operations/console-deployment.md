...
`559ba75`. The canonical `console.muxivo.pro` host remains separate and still
...
rollback. The frontend release `559ba75` is installed at
`/srv/muxivo-console/web`, and its previous web root is retained at
`/srv/muxivo-console/web.backup-559ba75` for rollback. The disabled
