...
The same authenticated relay is used for password recovery and organization
membership invitations. Invitation links are generated by Console and the raw
token is sent only in the e-mail body; it is never stored or logged by Console.
