...
- Discord: Discord Developer Portal → the existing application → OAuth2 →
  General. Register
  `https://beget.ame-life.com/api/v1/auth/discord/callback` and keep the
  client ID/secret in Vault.
- Twitch: Twitch Developer Console → Applications. Register
  `https://beget.ame-life.com/api/v1/auth/twitch/callback` and keep the
  client ID/secret in Vault.
