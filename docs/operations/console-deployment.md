...
`7fa7e4c`. The canonical `console.muxivo.pro` host remains separate and still
...
rollback. The frontend release `7fa7e4c` is installed at
`/srv/muxivo-console/web`, and its previous web root is retained at
`/srv/muxivo-console/web.backup-7fa7e4c` for rollback. The disabled
